...
const UICaseStudyHC = () => {
  return (
    <div name='uicshchead' className='w-full mx-auto px-32 flex flex-col justify-center bg-[#1F1F21]'>
      ...
      <div className='w-full mx-auto px-32 flex flex-col items-center justify-center  bg-[#9995C8]'>
        <h1 className='text-4xl font-bold inline border-4 px-4 py-2 m-8 bg-[#1F1F21] border-pink-600 text-[#F5F5FA]'>Work Samples</h1>
