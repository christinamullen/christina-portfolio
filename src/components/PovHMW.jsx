...
const PovHMW = () => {
    return (
        <div name='povhmw' className=' flex flex-col justify-center bg-[#9995C8]'>
            <div className='w-full mx-auto px-8 flex flex-col items-center justify-center bg-[#9995C8]'>
                ...
                <div className='max-w-[1200px] grid grid-cols-1 sm:grid-cols-3 gap-8 py-8'>
                    <div name='col1'>
                        <img className='max-w-[304px] mx-auto' src={guestPOV} alt='guest POV' />
                    </div>
                    <div name='col2' className='grid grid-cols-1 sm:grid-cols-2 sm:pt-56'>
                    ...
                    <div name='col3'>
                        <img className='max-w-[304px] mx-auto' src={hostPOV} alt='host POV' />
                    </div>
                </div>
            </div>
        </div>
