                ...
                <div className='max-w-[1200px] grid grid-cols-1 sm:grid-cols-3 gap-8 py-8'>
                    ...
                    <div name='col1' className='order-2 sm:order-2 mx-auto'>
                        <div className='w-[300px] flex flex-col items-center justify-center border-2 border-[#F5F5FA] bg-[#9995C8] pb-8 mb-6'>
                            ...
                            <ul>
                                <li>Lonely. Has apprehensions about having foreign unverified guests in the house. Can’t travel as much as she wants so wants to meet people from other countries. Tokyo is an expensive place to live. Worries about disrespectful guests</li>
                            </ul>
                        </div>
                        <div className='w-[300px] flex flex-col items-center justify-center border-2 border-[#F5F5FA] bg-[#9995C8] pb-8'>
                            ...
                            <ul className='py-2'>
                                <li>Knowledgeable about local flora, Conscious about the environment, Social and eager to meet and learn about others, Likes to cook and entertain, Interested in global customs, Interested in cultural immersion</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div name='col3' className='order-3'>
                        ...
                        <div className='w-[300px] flex flex-col items-center justify-center border-2 border-[#F5F5FA] bg-[#9995C8] pb-8'>
                            ...
                            <p className='px-4'>Sayuri and her husband live in the Shibuya district of Tokyo. Their children have gone off to college. Since she has extra rooms, and misses having people in the house. She would like some extra money and teach people about Japanese culture.</p>
                        </div>
                    </div>
                </div>
            </div >
