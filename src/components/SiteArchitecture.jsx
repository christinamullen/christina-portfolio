...
const SiteArchitecture = () => {
    return (
        <div name="architecture" className='w-full mx-auto py-16 flex flex-col items-center justify-center bg-[#1F1F21]'>
            ...
            <img className='max-h-[640px] mx-auto p-8' src={siteArchitecture} alt='app architecture' />
        </div>
    )
}
